...
public class WaxableRegistry {
    private static final BiMap<Block, Identifier> waxables = HashBiMap.create();
    private static final Supplier<BiMap<Identifier, Block>> waxables_prev = Suppliers.memoize(waxables::inverse);
