 ...
 */
public class SimpleBlockItemBase extends BlockItem implements PolymerItem, FilamentItem, Equipable, BehaviourHolder {
    ...
    public SimpleBlockItemBase(Block block, Properties properties, ItemData itemData, Item vanillaItem) {
    ...
    public SimpleBlockItemBase(Block block, Properties itemProperties, ItemProperties props, Item vanillaItem) {
